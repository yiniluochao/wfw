          ...
          <div class="col-xs-12"> 
            ...
            <div class="page-content">
              <form class="form-search" method="post" action="/product/search">
                    <div class="row">
                        <div class="col-md-8">
                                  <input class="col-md-10" style="height:34px;border:1px solid #6fb3e0" placeholder=" 产品查找(输入产品名称/自定义产品代码）" type="text" name="key">
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="widget-box">
                    ...
                    <h4>产品列表</h4>
                    <div class="widget-toolbar no-border"><a class="btn btn-sm btn-success" href="/product/newone/">新增产品</a></div>
                    </div>
                    ...
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                  ...
                                  <a href="/product/edit/<?php echo ($vo["pid"]); ?>" class="btn btn-xs btn-info"> <i class="icon-edit bigger-120"></i>编辑</a>   </div>
