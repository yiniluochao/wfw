            ...
            <div class="widget-box">
              ...
              <div class="widget-body">
				...
				<div class="widget-main">
                  ...
                  <div class="controls">
                    ...
                    <p class="help-block"></p>
					 ...
					 <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label">申请产品身份码位数</label>
                  <div class="controls">
                    <input class="form-control"  type="text" disabled value="<?php echo ($number); ?>" name="number">
                    <p class="help-block"></p>
                  </div>
                   </div>       
                  ...
                  <div class="controls">
                    <input class="form-control"  type="text" disabled value="<?php echo ($sum); ?>" name="sum">
                    <p class="help-block"></p>
                  </div>
                   </div>       
                       <div class="widget-main">
                  ...
                  <div class="controls">
                    <input class="form-control"  type="text" disabled value="<?php echo ($state); ?>" name="state"  >
                    <p class="help-block"></p>
                  </div>
                   </div>        
                  ...
                  <div class="controls">
                    <input class="form-control"  type="text" disabled="true" value="<?php echo ($createtime); ?>" name="createtime">
                    <p class="help-block"></p>
                  </div>
                   </div>
                      <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label">红包功能状态</label>
                  <div class="controls">
                    <input class="form-control"  type="text" disabled="true" value="<?php echo ($hongbao_state); ?>" name="hongbao_state">
                    <p class="help-block"></p>
                  </div>
                   </div>      
                            ...
                            <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label">点击下载产品身份码</label>
                  <div class="controls">
                   <a type="button"  href="/pecorder/download/<?php echo ($sum); ?>/<?php echo ($pec_order_id); ?>/<?php echo ($number); ?>"  class="btn btn-xs btn-success"> <i class="icon-exchange bigger-120"></i>下载</a>
                    <p class="help-block"></p>
                  </div>
                   </div>     
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  <a type="button" class="btn btn-success" href="/pecorder/manager/<?php echo ($bid); ?>">返回
                </a>
                  </div>
                </div>
