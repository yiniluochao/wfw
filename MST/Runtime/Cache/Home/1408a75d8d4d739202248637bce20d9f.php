...
<div class="sidebar" id="sidebar">
            ...
            <div class="widget-box">
              ...
              <div class="widget-body">
                <div class="widget-main">
                   ...
                   <form class="form" method="post" action="/apiconfig/newone_deal">
              <fieldset>
                     <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_id">api_id</label>
                  <div class="controls">
                    <input class="form-control"   disabled type="text" value="<?php echo ($api_id); ?>" name="api_id">
 ...
 <!--   <div class="widget-main">
                  ...
                  <label class="control-label" for="api_login">接口登录名</label>
                  <div class="controls">
                    <input class="form-control"  disabled type="text" value="<?php echo ($api_login); ?>" name="api_login">
                    <p class="help-block"></p>
                  </div>
                                    </div>
   ...
   <div class="widget-main">
                  ...
                  <label class="control-label" for="api_password">接口登录密码</label>
                  <div class="controls">
                    <input class="form-control"  type="text" value="<?php echo ($api_password); ?>" name="api_password">
                    <p class="help-block"></p>
                  </div>
                      </div> -->
   ...
   <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_appid">AppID(应用ID)</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_appid); ?>" name="api_weixin_appid">
                    <p class="help-block"></p>
                  </div>
                </div>
                ...
                <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_aes_key">AppSecret(应用密钥)</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_aes_key); ?>" name="api_weixin_aes_key">
                    <p class="help-block"></p>
                  </div>
                </div>
              <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_token">Token(令牌)</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_token); ?>" name="api_weixin_token">
                    <p class="help-block"></p>
                  </div>
                </div>
                      ...
                      <!--   <div class="widget-main">
                  <!-- Text input
                  <label class="control-label" for="api_other_url">第三方URL服务地址</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_other_url); ?>" name="api_other_url">
                    <p class="help-block"></p>
                  </div>
                </div> -->
                <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_pay_account">微信支付商户号</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_pay_account); ?>" name="api_weixin_pay_account">
                    <p class="help-block"></p>
                  </div>
                </div>
                <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_pay_key">微信支付密钥</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_pay_key); ?>" name="api_weixin_pay_key">
                    <p class="help-block"></p>
                  </div>
                </div>
                <div class="widget-main">
                  <!-- Text input-->
                  <label class="control-label" for="api_weixin_client_ip">服务器IP</label>
                  <div class="controls">
                    <input class="form-control"   type="text" value="<?php echo ($api_weixin_client_ip); ?>" name="api_weixin_client_ip">
                    <p class="help-block"></p>
                  </div>
                </div>
