          ...
          <div class="col-xs-12"> 
            ...
            <div class="page-content">
              <form class="form-search" method="post" action="/pecorder/search">
                    <div class="row">
                        <div class="col-md-8">
                                  <input class="col-md-10" style="height:34px;border:1px solid #6fb3e0" placeholder=" 订单查找(输入订单号）" type="text" name="key">
                          <button type="submit" class="btn btn-info btn-sm col-md-2">查找</button>
                        </div>
                    </div>
                  </form>
            </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="widget-box">
                    ...
                    <h4>订单列表</h4>
                    <div class="widget-toolbar no-border"><a class="btn btn-sm btn-success" href="/pecorder/newone/<?php echo ($bid); ?>">新增订单</a><label class="control-label" ><?php echo ($product_code); ?></label></div>
                    </div>
                  ...
                  <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><?php echo ($vo["pec_order_code"]); ?></td>
                          <td><?php echo ($vo["sum"]); ?></td>
                          <td><?php echo ($vo["createtime"]); ?></td>
                           
                          <td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                  <a href="/pecorder/view/<?php echo ($vo["pec_order_id"]); ?>"target="_self" class="btn btn-xs btn-purple"><i class="icon-book bigger-120"></i>状态查看</a>
                                  <a href="/pecorder/edit/<?php echo ($vo["pec_order_id"]); ?>"target="_self" class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i>订单更改</a>
