            ...
            <div class="widget-box">
              ...
              <div class="widget-body">
                <div class="widget-main">
                 <form class="form" enctype="multipart/form-data" method="post" action="/weixin/hongbao_display_edit">
              <fieldset>
              <div class="widget-main col-md-7 ">
                  <!-- Text input-->
                  <label class="control-label" for="company_name"> <b style="color:red;">*</b> 企业名称</label>
                  <label class="text-muted">(此处名称为微信端领取红包页显示)</label> 
                  <div class="controls">
                  ...
                  <div class="widget-main col-md-7 ">
                  <!-- Text input-->
                  <label class="control-label" for="startpoint"><b style="color:red;">*</b> 企业logo  </label>
                  <label class="text-muted">(此logo为微信端领取红包页显示)</label>
                     <input type='file'  name='photo[]'>
                    <p class="help-block"></p>
                  </div>
                     <div class="widget-main col-md-7 ">
                  <!-- Text input-->
                  <label class="control-label" for="onece_money"><b style="color:red;">*</b> 单个红包现金</label>
                  <label class="text-muted">(单位:分)</label>
                  <div class="controls">
                    <input class="form-control"  type="text" value="<?php echo ($onece_money); ?>" name="onece_money">
                    <p class="help-block"></p>
                  </div>
                                    </div>
                      <div class="widget-main col-md-7 ">
                  <!-- Text input-->
                  <label class="control-label" for="bless_message"> 祝福语</label>
                  <div class="controls">
                    <input class="form-control"  type="text" value="<?php echo ($bless_message); ?>" name="bless_message">
                    <p class="help-block"></p>
                  </div>
                                    </div>
             ...
             <div class="widget-main col-md-7 ">
                  ...
                  <div class="controls">
                    <button class="btn btn-success">提交</button>
                       <a type="button" class="btn btn-inverse" href="javascript:history.go(-1);">返回
                </a>
                  </div>
                </div>
