...
class WxHongBaoHelper
{
	...
	/**
	  例如：
		...
		9CF3B7"
	 */
	protected function get_sign($api_weixin_pay_key){
		define('PARTNERKEY',$api_weixin_pay_key);
		try {
	...
	*/
	function create_hongbao_xml($retcode = 0, $reterrmsg = "ok",$api_weixin_pay_key){
		 try {
		    $this->setParameter('sign', $this->get_sign($api_weixin_pay_key));
		    $commonUtil = new CommonUtil();
